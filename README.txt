...
Grafickú stránku hry reprezentuje trieda GUI, obsahuje hraciu plochu a herné štatistiky nad ňou. Tiež sa tam nachádza nová a uložená karta, na ktoré môže hráč klikať, a tak si položky ukladať alebo prepínať medzi uloženou a novou položkou. GUI má podtriedy CardPane a BoardPane, existuje aj SpecialCardPane pre uloženú a novú kartu, ktoré majú aj label. V hre celý čas hrá hudba, pri klikaní počuť zvuky, pri skórovaní taktiež. 
